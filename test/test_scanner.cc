...
struct test_scan_empty_string : public test_basic_input {
    test_scan_empty_string() : test_basic_input("") { }
};
...
struct test_scan_whitespace : public test_basic_input {
    test_scan_whitespace() : test_basic_input("  ") { }
};
...
struct test_scan_sequence_begin : public test_basic_input {
    test_scan_sequence_begin() : test_basic_input("[") { }
};
...
struct test_scan_sequence_end : public test_basic_input {
    test_scan_sequence_end() : test_basic_input("]") { }
};
...
struct test_scan_mapping_begin : public test_basic_input {
    test_scan_mapping_begin() : test_basic_input("{") { }
};
...
struct test_scan_mapping_end : public test_basic_input {
    test_scan_mapping_end() : test_basic_input("}") { }
};
...
struct test_scan_mapping_begin_end : public test_basic_input {
    test_scan_mapping_begin_end() : test_basic_input("{  }") { }
};
...
struct test_scan_mapping_sequence_begin_end : public test_basic_input {
    test_scan_mapping_sequence_begin_end() : test_basic_input("{ 	[ ]}") { }
};
...
struct test_scan_digit : public test_basic_input {
    test_scan_digit() : test_basic_input("0") { }
};
...
struct test_scan_integer : public test_basic_input {
    test_scan_integer() : test_basic_input("1337042") { }
};
...
struct test_scan_pair_separator : public test_basic_input {
    test_scan_pair_separator() : test_basic_input(": ") { }
};
...
struct test_scan_sequence_separator : public test_basic_input {
    test_scan_sequence_separator() : test_basic_input(", ") { }
};
...
struct test_scan_quoted_string : public test_basic_input {
    test_scan_quoted_string() : test_basic_input("'Grokking the grammar'") { }
};
...
struct test_scan_unquoted_string : public test_basic_input {
    test_scan_unquoted_string() : test_basic_input("email address") { }
};
...
struct test_scan_pair : public test_basic_input {
    test_scan_pair() : test_basic_input("email: ee@mail.box") { }
};
...
struct test_scan_string_with_colon : public test_basic_input {
    test_scan_string_with_colon() : test_basic_input("email:ee@mail.box") { }
};
...
struct test_scan_string_with_command_and_space : public test_basic_input {
    test_scan_string_with_command_and_space() : test_basic_input("hello, world") { }
};
...
struct test_scan_sequence_elements : public test_basic_input {
    test_scan_sequence_elements() : test_basic_input("[hello, world]") { }
};
...
struct test_scan_mapping_pairs : public test_basic_input {
    test_scan_mapping_pairs() : test_basic_input("{ np: hard }") { }
};
...
struct test_scan_nested_sequence : public test_basic_input {
    test_scan_nested_sequence() : test_basic_input("[a, [b]]") { }
};
...
struct test_scan_nested_sequence2 : public test_basic_input {
    test_scan_nested_sequence2() :
        test_basic_input("{name: Richard Stallman, email: rms@gnu.org}") { }
};
...
struct test_scan_string_with_comma : public test_basic_input {
    test_scan_string_with_comma() : test_basic_input("no,space") { }
};
...
struct test_scan_document_begin : public test_basic_input {
    test_scan_document_begin() : test_basic_input("--- ") { }
};
...
struct test_scan_three_dashes_string : public test_basic_input {
    test_scan_three_dashes_string() : test_basic_input("---") { }
};
